...
def parse_args():
    ...
    parser.add_argument("--no_cuda",
                        ...
                        action='store_true')
    parser.add_argument("--custom_scale", type=float, default=100., help="custom scale factor for depth maps")
    ...
    parser.add_argument("--eval_uncert", help="if set enables uncertainty evaluation", action="store_true")
    parser.add_argument("--dropout", help="if set enables dropout inference", action="store_true")
    parser.add_argument("--bootstraps", type=int, default=1, help="if > 1, loads multiple checkpoints from different trainings to build a bootstrapped ensamble")
    parser.add_argument("--snapshots", type=int, default=1, help="if > 1, loads the last N checkpoints to build a snapshots ensemble")
    parser.add_argument("--output_dir", type=str, default="output", help="output directory for predicted depth and uncertainty maps")
    parser.add_argument("--qual", help="if set save colored depth and uncertainty maps", action="store_true")
